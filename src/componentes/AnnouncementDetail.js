...
import SwiperAnounc from './SwiperAnounc';
...
function AnnouncementDetail() {
  ...
  useEffect(() => {
    fetch(`https://localhost/school/api.php?id=${id}`) // Adjust API endpoint as needed
      ...
      <div className="announcement-detail p-8 bg-gradient-to-r from-orange-100 via-gray-100 to-pink-100 min-h-screen">
        <div className="container mx-auto">
          <div className="bg-white p-6 rounded-lg shadow-xl">
            <h1 className="text-5xl font-extrabold text-gray-900 mb-4">{announcement.title}</h1>
            <p className="text-gray-700 text-lg mb-6 font-semibold">Details: {announcement.subject}</p>
